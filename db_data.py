...
#
# insert_to_db(converter_pages, {'name': "Сантиметры² в дециметры²", 'ff': "cm", 'tf': 'dm', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в метры²", 'ff': "cm", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_m2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в километры²", 'ff': "cm", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_km2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в дюймы²", 'ff': "cm", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_inch2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в футы²", 'ff': "cm", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в гектары", 'ff': "cm", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в акры", 'ff': "cm", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'cm2_akr2.png'})
#
#
# insert_to_db(converter_pages, {'name': "Метры² в дециметры²", 'ff': "m", 'tf': 'dm', 'category': 33, 'image': IMAGE_FOLDER + 'm2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в сантиметры²", 'ff': "m", 'tf': 'cm', 'category': 33, 'image': IMAGE_FOLDER + 'm2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в километры²", 'ff': "m", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'm2_km2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в дюймы²", 'ff': "m", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'm2_inch2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в футы²", 'ff': "m", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'm2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в гектары", 'ff': "m", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'm2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Метры² в акры", 'ff': "m", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'm2_akr2.png'})
#
#
# insert_to_db(converter_pages, {'name': "Дециметры² в метры²", 'ff': "dm", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'dm2_m2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в сантиметры²", 'ff': "dm", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'dm2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в километры²", 'ff': "dm", 'tf': 'km',  'category': 33, 'image': IMAGE_FOLDER + 'dm2_km2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в дюймы²", 'ff': "dm", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'dm2_inch2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в футы²", 'ff': "dm", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'dm2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в гектары", 'ff': "dm", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'dm2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в акры", 'ff': "dm", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'dm2_akr2.png'})
#

# insert_to_db(converter_pages, {'name': "Километры² в метры²", 'ff': "km", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'km2_m2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в сантиметры²", 'ff': "km", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'km2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в дециметры²", 'ff': "km", 'tf': 'dm',  'category': 33, 'image': IMAGE_FOLDER + 'km2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в дюймы²", 'ff': "km", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'km2_inch2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в футы²", 'ff': "km", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'km2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в гектары", 'ff': "km", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'km2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Километры² в акры", 'ff': "km", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'km2_akr2.png'})
#

# insert_to_db(converter_pages, {'name': "Дюймы² в метры²", 'ff': "in", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'in2_m2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в сантиметры²", 'ff': "in", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'in2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в дециметры²", 'ff': "in", 'tf': 'dm',  'category': 33, 'image': IMAGE_FOLDER + 'in2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в километры²", 'ff': "in", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'in2_km2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в футы²", 'ff': "in", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'in2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в гектары", 'ff': "in", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'in2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Дюймы² в акры", 'ff': "in", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'in2_akr2.png'})


# insert_to_db(converter_pages, {'name': "Футы² в метры²", 'ff': "ft", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'ft2_m2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в сантиметры²", 'ff': "ft", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'ft2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в дециметры²", 'ff': "ft", 'tf': 'dm',  'category': 33, 'image': IMAGE_FOLDER + 'ft2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в километры²", 'ff': "ft", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'ft2_km2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в дюймы²", 'ff': "ft", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'ft2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в гектары", 'ff': "ft", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'ft2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Футы² в акры", 'ff': "ft", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'ft2_akr2.png'})

# insert_to_db(converter_pages, {'name': "Гектары в метры²", 'ff': "ga", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'ga2_m2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в сантиметры²", 'ff': "ga", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'ga2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в дециметры²", 'ff': "ga", 'tf': 'dm',  'category': 33, 'image': IMAGE_FOLDER + 'ga2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в километры²", 'ff': "ga", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'ga2_km2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в дюймы²", 'ff': "ga", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'ga2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в футы", 'ff': "ga", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'ga2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Гектары в акры", 'ff': "ga", 'tf': 'akr', 'category': 33, 'image': IMAGE_FOLDER + 'ga2_akr2.png'})

# insert_to_db(converter_pages, {'name': "Акры в метры²", 'ff': "akr", 'tf': 'm', 'category': 33, 'image': IMAGE_FOLDER + 'akr2_m2.png'})
# insert_to_db(converter_pages, {'name': "Акры в сантиметры²", 'ff': "akr", 'tf': 'cm',  'category': 33, 'image': IMAGE_FOLDER + 'akr2_cm2.png'})
# insert_to_db(converter_pages, {'name': "Акры в дециметры²", 'ff': "akr", 'tf': 'dm',  'category': 33, 'image': IMAGE_FOLDER + 'akr2_dm2.png'})
# insert_to_db(converter_pages, {'name': "Акры в километры²", 'ff': "akr", 'tf': 'km', 'category': 33, 'image': IMAGE_FOLDER + 'akr2_km2.png'})
# insert_to_db(converter_pages, {'name': "Акры в дюймы²", 'ff': "akr", 'tf': 'in', 'category': 33, 'image': IMAGE_FOLDER + 'akr2_ft2.png'})
# insert_to_db(converter_pages, {'name': "Акры в футы", 'ff': "akr", 'tf': 'ft', 'category': 33, 'image': IMAGE_FOLDER + 'akr2_ga2.png'})
# insert_to_db(converter_pages, {'name': "Акры в гектары", 'ff': "akr", 'tf': 'ga', 'category': 33, 'image': IMAGE_FOLDER + 'akr2_akr2.png'})
