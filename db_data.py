...
#
# insert_to_db(converter_pages, {'name': "Метры в Миллиметры", 'slug': "m_mm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Метры в Сантиметры", 'slug': "m_cm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Метры в Дециметры", 'slug': "m_dm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Метры в Километры", 'slug': "m_km", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Метры в Дюймы", 'slug': "m_inch", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Метры в Ярды", 'slug': "m_ya", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
#
# insert_to_db(converter_pages, {'name': "Километры в Миллиметры", 'slug': "km_mm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Километры в Сантиметры", 'slug': "km_cm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Километры в Дециметры", 'slug': "km_dm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Километры в Метры", 'slug': "km_m", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Километры в Дюймы", 'slug': "km_inch", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Километры в Ярды", 'slug': "km_ya", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
#
# insert_to_db(converter_pages, {'name': "Дюймы в Миллиметры", 'slug': "inch_mm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Сантиметры", 'slug': "inch_cm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Дециметры", 'slug': "inch_dm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Метры", 'slug': "inch_m", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Километры", 'slug': "inch_km", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Футы", 'slug': "inch_ft", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Дюймы в Ярды", 'slug': "inch_ya", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
#
# insert_to_db(converter_pages, {'name': "Футы в Миллиметры", 'slug': "ft_mm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Сантиметры", 'slug': "ft_cm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Дециметры", 'slug': "ft_dm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Метры", 'slug': "ft_m", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Километры", 'slug': "ft_km", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Дюймы", 'slug': "ft_inch", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Футы в Ярды", 'slug': "ft_ya", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
#
#
# insert_to_db(converter_pages, {'name': "Ярды в Миллиметры", 'slug': "ya_mm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Сантиметры", 'slug': "ya_cm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Дециметры", 'slug': "ya_dm", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Метры", 'slug': "ya_m", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Километры", 'slug': "ya_km", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Дюймы", 'slug': "ya_inch", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
# insert_to_db(converter_pages, {'name': "Ярды в Футы", 'slug': "ya_ft", 'category': 32, 'image': IMAGE_FOLDER + 'distance_i.png'})
#
# insert_to_db(converter_pages, {'name': "Сантиметры² в дециметры²", 'slug': "cm2_dm2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в метры²", 'slug': "cm2_m2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в километры²", 'slug': "cm2_km2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в дюймы²", 'slug': "cm2_inch2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в футы²", 'slug': "cm2_ft2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в гектары", 'slug': "cm2_ga2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Сантиметры² в акры", 'slug': "cm2_akr2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
#
#
# insert_to_db(converter_pages, {'name': "Метры² в дециметры²", 'slug': "m2_dm2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в сантиметры²", 'slug': "m2_cm2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в километры²", 'slug': "m2_km2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в дюймы²", 'slug': "m2_inch2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в футы²", 'slug': "m2_ft2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в гектары", 'slug': "m2_ga2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Метры² в акры", 'slug': "m2_akr2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
#
#
# insert_to_db(converter_pages, {'name': "Дециметры² в метры²", 'slug': "dm2_m2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в сантиметры²", 'slug': "dm2_cm2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в километры²", 'slug': "dm2_km2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в дюймы²", 'slug': "dm2_inch2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в футы²", 'slug': "dm2_ft2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в гектары", 'slug': "dm2_ga2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
# insert_to_db(converter_pages, {'name': "Дециметры² в акры", 'slug': "dm2_akr2", 'category': 33, 'image': IMAGE_FOLDER + 'square_i.png'})
#
